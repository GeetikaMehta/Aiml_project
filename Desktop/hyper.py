...
#page laylout 
st.set_page_config(page_title = 'The Machine Learning Hyperparameter opt app',layout = "wide")
...
#sidebar-- collects users inputs features into dataframe 
st.sidebar.header('Upload your CSV data')
uploaded_file = st.sidebar.file_uploader("Uploader your input CSV file",type=['csv'])
st.sidebar.markdown("""
[Example CSV input file](https://raw.githubusercontent.com/dataprofessor/data/master/delaney_solubility_with_descriptors.csv)
""") 

#sidebar -- specify parameter settings 
st.sidebar.header('Set Parameter')
